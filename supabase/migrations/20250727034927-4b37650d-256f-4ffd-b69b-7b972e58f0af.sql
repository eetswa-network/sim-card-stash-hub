...
-- Remove login and password columns from sim_cards (optional - keeping for now in case of rollback needs)
-- ALTER TABLE public.sim_cards DROP COLUMN login;
-- ALTER TABLE public.sim_cards DROP COLUMN password;